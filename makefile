...
COMPILER_FLAGS		=	-g -Wall -c -std=c++11 `mysql_config --cflags` `mysql_config --libs` -fpic -o
LINKER_FLAGS		=	-shared
LINKER_DEPENDENCIES	=	-lphpcpp -lmysqlcppconn
...
${OBJECTS}:
						${COMPILER} ${COMPILER_FLAGS} $@ ${@:$(OBJ_DIR)/%.o=$(SRC_DIR)/%.cpp}
